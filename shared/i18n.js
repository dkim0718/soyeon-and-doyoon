...
window.STRINGS = {
  en: {
    ...
    rsvp: {
      ...
      // afterparty (curated list + allotment)
      lookupHeading: 'Find your invitation',
      lookupHint: 'Enter the name on your invitation.',
      lookupBtn: 'Continue',
      lookupByCode: 'Have a personal RSVP link? Just open it.',
      notFound: "We couldn't find that invitation. Please double-check the spelling, or reach out to us.",
  ...
  ko: {
    ...
    rsvp: {
      ...
      lookupHeading: '초대 확인',
      lookupHint: '초대장에 적힌 성함을 입력해 주세요.',
      lookupBtn: '다음',
      lookupByCode: '개인 초대 링크가 있으시면 그대로 열어 주세요.',
      notFound: '초대 내역을 찾지 못했습니다. 성함을 다시 확인하시거나 신랑·신부에게 문의해 주세요.',
